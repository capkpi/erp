...
from erp.setup.doctype.item_group.item_group import (
...
class WebsiteItem(WebsiteGenerator):
	...
	def set_metatags(self, context):
		...
		context.metatags["og:site_name"] = "ERP"
...
def invalidate_cache_for_web_item(doc):
	...
	from erp.stock.doctype.item.item import invalidate_item_variants_cache_for_website
