...
from erp.stock.doctype.item.item import DataValidationError
...
class TestWebsiteItem(unittest.TestCase):
	...
	def test_index_creation(self):
		...
		from erp.e_commerce.doctype.website_item.website_item import on_doctype_update
	...
	def test_website_item_breadcrumbs(self):
		...
		from erp.setup.doctype.item_group.item_group import get_parent_item_groups
