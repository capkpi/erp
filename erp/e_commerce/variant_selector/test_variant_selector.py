...
from erp.e_commerce.variant_selector.utils import get_next_attribute_and_values
from erp.stock.doctype.item.test_item import make_item

test_dependencies = ["Item"]


class TestVariantSelector(CapKPITestCase):
	@classmethod
	def setUpClass(cls):
	...
	def test_item_attributes(self):
		...
		"""
		from erp.e_commerce.variant_selector.utils import get_attributes_and_values
		...
		small_variant = capkpi.get_doc("Item", "Test-Tshirt-Temp-S-R")
	...
	def test_exact_match_with_price(self):
		...
		"""
		from erp.e_commerce.doctype.website_item.test_website_item import make_web_item_price
		...
		capkpi.local.shopping_cart_settings = None  # clear cached settings values
		next_values = get_next_attribute_and_values(
