...
from capkpi.utils import sanitize_html
from capkpi.utils.global_search import search
...
def get_context(context):
	context.no_cache = 1
	if capkpi.form_dict.q:
		query = str(utils.escape(sanitize_html(capkpi.form_dict.q)))
...
def get_help_results_sections(text):
	out = []
	settings = capkpi.get_doc("Support Settings", "Support Settings")
