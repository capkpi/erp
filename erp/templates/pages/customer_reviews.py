...
from erp.e_commerce.doctype.website_item.website_item import check_if_user_is_customer
...
def get_context(context):
	...
	if capkpi.form_dict and capkpi.form_dict.get("web_item"):
		context.web_item = capkpi.form_dict.get("web_item")
