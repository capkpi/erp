...
import erp
from erp.accounts.utils import get_currency_precision, get_stock_accounts
from erp.stock.doctype.warehouse.warehouse import get_warehouses_based_on_account
