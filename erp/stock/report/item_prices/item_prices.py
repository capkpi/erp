...
def execute(filters=None):
	...
	from erp.accounts.utils import get_currency_precision
...
def get_last_purchase_rate():
	...
	for d in capkpi.db.sql(query, as_dict=1):
