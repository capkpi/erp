...
def get_incorrect_serial_nos(serial_nos_data):
	...
	total_value = capkpi._dict(
		{"qty": 0, "valuation_rate": 0, "serial_no": capkpi.bold(_("Balance"))}
	)

	for serial_no, data in iteritems(serial_nos_data):
		total_dict = capkpi._dict({"qty": 0, "valuation_rate": 0, "serial_no": capkpi.bold(_("Total"))})
