...
test_records = capkpi.get_test_records("Serial No")


class TestSerialNo(CapKPITestCase):
	def tearDown(self):
		capkpi.db.rollback()

	def test_cannot_create_direct(self):
		capkpi.delete_doc_if_exists("Serial No", "_TCSER0001")
	...
	def test_inter_company_transfer(self):
		...
		serial_no = capkpi.get_doc("Serial No", serial_nos[0])
	...
	def test_inter_company_transfer_intermediate_cancellation(self):
		...
		sn_doc = capkpi.get_doc("Serial No", serial_nos[0])
		...
		self.assertRaises(capkpi.ValidationError, se.cancel)
		...
		self.assertRaises(capkpi.ValidationError, dn.cancel)
		...
		self.assertRaises(capkpi.ValidationError, se.cancel)
		self.assertRaises(capkpi.ValidationError, dn.cancel)
		self.assertRaises(capkpi.ValidationError, pr.cancel)
	...
	def test_auto_fetch(self):
		...
		# expiry date
		capkpi.db.set_value("Batch", batch1, "expiry_date", "1980-01-01")
