...
def execute(filters=None):
	...
	if capkpi.db.has_column("Employee", "ifsc_code"):
		columns.append(
	...
	for salary in salary_slips:
		if (
			...
			row = {
				...
				"payment_date": capkpi.utils.formatdate(salary.modified.strftime("%Y-%m-%d")),
				...
				"currency": capkpi.get_cached_value("Company", filters.company, "default_currency"),
