...
class StockController(AccountsController):
	...
	def make_gl_entries(self, gl_entries=None, from_repost=False):
		...
		if (
			cint(erp.is_perpetual_inventory_enabled(self.company))
	...
	def clean_serial_nos(self):
		from erp.stock.doctype.serial_no.serial_no import clean_serial_no_string
	...
	def validate_putaway_capacity(self):
		...
		from erp.stock.doctype.putaway_rule.putaway_rule import get_available_putaway_capacity
