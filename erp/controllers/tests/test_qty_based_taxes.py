...
class TestTaxes(unittest.TestCase):
	def setUp(self):
		...
		self.item_group = capkpi.get_doc(
			{
				"doctype": "Item Group",
		...
		self.item_tax_template = capkpi.get_doc(
			{
			...
			doc = capkpi.get_doc(
				{
					...
					"currency": "USD",
					"schedule_date": capkpi.utils.nowdate(),
					"delivery_date": capkpi.utils.nowdate(),
