...
from erp.stock.doctype.item.item import set_item_default
from erp.stock.get_item_details import get_bin_details, get_conversion_factor
...
class SellingController(StockController):
	...
	def set_missing_lead_customer_details(self, for_validate=False):
		...
		if customer:
			...
			from erp.crm.doctype.lead.lead import get_lead_details
	...
	def validate_items(self):
		...
		from erp.controllers.buying_controller import validate_item_type
