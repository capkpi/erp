...
def execute():
	if capkpi.db.exists("DocType", "Membership Settings"):
		capkpi.rename_doc("DocType", "Membership Settings", "Non Profit Settings")
		capkpi.reload_doctype("Non Profit Settings", force=True)

	if capkpi.db.exists("DocType", "Non Profit Settings"):
		rename_fields_map = {
		...
		capkpi.delete_doc_if_exists("DocType", "Membership Settings")
