...
def execute():
	capkpi.reload_doc("accounts", "doctype", "advance_taxes_and_charges")
	capkpi.reload_doc("accounts", "doctype", "payment_entry")
	...
	if capkpi.db.exists("Company", {"country": "India"}):
		...
		for field in fields:
			capkpi.delete_doc_if_exists("Custom Field", f"Payment Entry-{field}")
