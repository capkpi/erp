import capkpi
from capkpi.utils import get_time, getdate, today

from erp.accounts.utils import update_gl_entries_after
from erp.stock.stock_ledger import update_entries_after
...
def execute():
	...
	capkpi.clear_cache()
	capkpi.flags.warehouse_account_map = {}
	...
	if data:
		for row in capkpi.get_all("Company", filters={"enable_perpetual_inventory": 1}):
