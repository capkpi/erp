...
def execute():
	...
	for doctype in ["Sales Invoice", "Delivery Note"]:
		if not capkpi.get_meta(doctype + " Item").get_field("target_warehouse").hidden:
			continue
	...
	if capkpi.get_meta("Sales Order Item").get_field("target_warehouse").hidden:
		capkpi.db.sql(
