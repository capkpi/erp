...
erp.buying.RequestforQuotationController = erp.buying.BuyingController.extend({
	refresh: function() {
		var me = this;
		this._super();
			...
			this.frm.add_custom_button(__('Possible Supplier'), function() {
				...
				var dialog = new frappe.ui.Dialog({
					...
					primary_action: (args) => {
						...
						erp.utils.map_current_doc({
							method: "erp.buying.doctype.request_for_quotation.request_for_quotation.get_item_from_material_requests_based_on_supplier",
...
$.extend(cur_frm.cscript, new erp.buying.RequestforQuotationController({frm: cur_frm}));
