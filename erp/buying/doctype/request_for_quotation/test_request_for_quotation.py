...
from erp.crm.doctype.opportunity.opportunity import make_request_for_quotation as make_rfq
...
from erp.templates.pages.rfq import check_supplier_has_docname_access


class TestRequestforQuotation(CapKPITestCase):
