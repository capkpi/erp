...
erp.buying.SupplierQuotationController = erp.buying.BuyingController.extend({
	setup: function() {
		...
		if (this.frm.doc.docstatus === 1) {
			...
			function() {
				...
				erp.utils.map_current_doc({
					...
					get_query_method: "erp.buying.doctype.request_for_quotation.request_for_quotation.get_rfq_containing_supplier"
...
$.extend(cur_frm.cscript, new erp.buying.SupplierQuotationController({frm: cur_frm}));
