...
from erp.stock.doctype.material_request.test_material_request import make_material_request
...
class TestPurchaseOrder(CapKPITestCase):
	...
	def test_purchase_order_invoice_receipt_workflow(self):
		from erp.accounts.doctype.purchase_invoice.purchase_invoice import make_purchase_receipt
