...
from erp.regional.united_arab_emirates.setup import make_custom_fields as uae_custom_fields
from erp.regional.saudi_arabia.wizard.operations.setup_ksa_vat_setting import (
...
def add_print_formats():
	capkpi.reload_doc("regional", "print_format", "detailed_tax_invoice", force=True)
	capkpi.reload_doc("regional", "print_format", "simplified_tax_invoice", force=True)
	capkpi.reload_doc("regional", "print_format", "tax_invoice", force=True)
	...
	for d in (
		...
		capkpi.db.set_value("Print Format", d, "disabled", 0)
...
def add_permissions():
	...
	capkpi.db.set_value("Report", "KSA VAT", "disabled", 0)
