...
class TestGSTR3BReport(unittest.TestCase):
	def setUp(self):
		...
		capkpi.db.sql("delete from `tabSales Invoice` where company='_Test Company GST'")
		capkpi.db.sql("delete from `tabPurchase Invoice` where company='_Test Company GST'")
		capkpi.db.sql("delete from `tabGSTR 3B Report` where company='_Test Company GST'")
	...
	def test_gstr_3b_report(self):
		...
		if capkpi.db.exists("GSTR 3B Report", "GSTR3B-March-2019-_Test Address GST-Billing"):
			report = capkpi.get_doc("GSTR 3B Report", "GSTR3B-March-2019-_Test Address GST-Billing")
			report.save()
		else:
	...
	def test_gst_category_auto_update(self):
		if not capkpi.db.exists("Customer", "_Test GST Customer With GSTIN"):
		...
		if not capkpi.db.exists("Address", "_Test GST Category-1-Billing"):
...
def make_suppliers():
	if not capkpi.db.exists("Supplier", "_Test Registered Supplier"):
		capkpi.get_doc(
			{
	...
	if not capkpi.db.exists("Supplier", "_Test Unregistered Supplier"):
		capkpi.get_doc(
			{
				"supplier_group": "_Test Supplier Group",
	...
	if not capkpi.db.exists("Address", "_Test Supplier GST-1-Billing"):
		address = capkpi.get_doc(
			{
				"address_line1": "_Test Address Line 1",
	...
	if not capkpi.db.exists("Address", "_Test Supplier GST-2-Billing"):
		address = capkpi.get_doc(
			{
				"address_line1": "_Test Address Line 1",
...
def make_customers():
	if not capkpi.db.exists("Customer", "_Test GST Customer"):
		capkpi.get_doc(
			{
				"customer_group": "_Test Customer Group",
	...
	if not capkpi.db.exists("Customer", "_Test GST SEZ Customer"):
		capkpi.get_doc(
			{
				"customer_group": "_Test Customer Group",
	...
	if not capkpi.db.exists("Customer", "_Test Unregistered Customer"):
		capkpi.get_doc(
			{
				"customer_group": "_Test Customer Group",
	...
	if not capkpi.db.exists("Address", "_Test GST-1-Billing"):
		address = capkpi.get_doc(
			{
				"address_line1": "_Test Address Line 1",
	...
	if not capkpi.db.exists("Address", "_Test GST-2-Billing"):
		address = capkpi.get_doc(
			{
				"address_line1": "_Test Address Line 1",
	...
	if not capkpi.db.exists("Address", "_Test GST-3-Billing"):
		address = capkpi.get_doc(
			{
				"address_line1": "_Test Address Line 1",
...
def make_company():
	if capkpi.db.exists("Company", "_Test Company GST"):
		return
	...
	if not capkpi.db.exists("Address", "_Test Address GST-Billing"):
		address = capkpi.get_doc(
			{
