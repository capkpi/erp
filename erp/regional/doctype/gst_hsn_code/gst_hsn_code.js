...
capkpi.ui.form.on('GST HSN Code', {
				...
				capkpi.confirm(
					...
					function(){
						capkpi.call({
							...
							method: 'erp.regional.doctype.gst_hsn_code.gst_hsn_code.update_taxes_in_item_master',
							callback: function(r) {
								if(r.message){
									capkpi.show_alert(__('Item taxes updated'));
								}
							}
						});
					}
