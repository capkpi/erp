...
capkpi.ui.form.on('Clinical Procedure Template', {
...
let change_template_code = function(doc) {
	let d = new capkpi.ui.Dialog({
		...
		primary_action: function() {
			...
			if (values) {
				capkpi.call({
					'method': 'erp.healthcare.doctype.clinical_procedure_template.clinical_procedure_template.change_item_code_from_template',
...
capkpi.tour['Clinical Procedure Template'] = [
	{
		fieldname: 'template',
	...
	},
	{
		...
		description: __('Check this if the Clinical Procedure utilises consumables. Click ') + "<a href='https://docs.capkpi.com/docs/user/manual/en/healthcare/clinical_procedure_template#22-manage-procedure-consumables' target='_blank'>here</a>" + __(' to know more')
