...
let calculate_bmi = function(frm){
	...
	capkpi.model.set_value(frm.doctype,frm.docname, 'bmi', bmi);
	capkpi.model.set_value(frm.doctype,frm.docname, 'nutrition_note', bmi_note);
};

let set_bp = function(frm){
	let bp = frm.doc.bp_systolic+ '/' + frm.doc.bp_diastolic + ' mmHg';
	capkpi.model.set_value(frm.doctype,frm.docname, 'bp', bp);
};
