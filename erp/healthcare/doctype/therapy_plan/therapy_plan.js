...
capkpi.ui.form.on('Therapy Plan', {
	setup: function(frm) {
			...
			if (frm.doc.status != 'Completed') {
				...
				frm.add_custom_button(__('Therapy Session'), function() {
					capkpi.prompt(fields, data => {
						capkpi.call({
							method: 'erp.healthcare.doctype.therapy_plan.therapy_plan.make_therapy_session',
							args: {
	...
	make_sales_invoice: function(frm) {
		capkpi.call({
			...
			method: 'erp.healthcare.doctype.therapy_plan.therapy_plan.make_sales_invoice',
			callback: function(r) {
...
capkpi.ui.form.on('Therapy Plan Detail', {
