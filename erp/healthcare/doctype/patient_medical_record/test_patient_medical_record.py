...
def create_procedure(appointment):
	if appointment:
		procedure = capkpi.new_doc("Clinical Procedure")
...
def create_vital_signs(appointment):
	vital_signs = capkpi.new_doc("Vital Signs")
...
def create_lab_test_template(medical_department):
	if capkpi.db.exists("Lab Test Template", "Blood Test"):
		return capkpi.get_doc("Lab Test Template", "Blood Test")
...
def create_lab_test(template, patient):
	...
	lab_test.patient_sex = capkpi.db.get_value("Patient", patient, "sex")
