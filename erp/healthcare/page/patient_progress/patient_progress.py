...
from capkpi.utils import get_timespan_date_range, getdate


@capkpi.whitelist()
def get_therapy_sessions_count(patient):
	total = capkpi.db.count("Therapy Session", filters={"docstatus": 1, "patient": patient})

	month_start = datetime.today().replace(day=1)
	this_month = capkpi.db.count(
