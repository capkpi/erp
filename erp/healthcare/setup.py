...
def setup_healthcare():
	if capkpi.db.exists("Medical Department", "Cardiology"):
		# already setup
		return
...
def create_medical_departments():
	...
	for department in departments:
		mediacal_department = capkpi.new_doc("Medical Department")
...
def create_antibiotics():
	...
	for a in abt:
		antibiotic = capkpi.new_doc("Antibiotic")
...
def get_company():
	...
	if company:
		...
		company = capkpi.get_list("Company", limit=1)
		if company:
