...
from erp.erp_integrations.utils import create_mode_of_payment
...
def get_account_balance(request_payload):
	...
	try:
		...
		callback_url = (
			get_request_site_address(True)
			+ "/api/method/erp.erp_integrations.doctype.mpesa_settings.mpesa_settings.process_balance_info"
		)
