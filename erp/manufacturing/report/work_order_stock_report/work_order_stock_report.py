...
import capkpi
from capkpi.query_builder.functions import IfNull
...
def get_item_list(wo_list, filters):
	...
	if wo_list:
		...
		for wo_details in wo_list:
			desc = capkpi.db.get_value("BOM", wo_details.bom_no, "description")

			for wo_item_details in capkpi.db.get_values(
