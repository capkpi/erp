...
from capkpi.utils.data import comma_and
...
def execute(filters=None):
	...
	for row in bom_data:
		...
		last_purchase_rate = capkpi.db.get_value("Item", row.item_code, "last_purchase_rate")
