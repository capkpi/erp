...
const capkpi_ui_tests_path = path_join(apps_path, 'capkpi', 'capkpi', 'tests', 'ui');

const login = require(capkpi_ui_tests_path + "/login.js")['Login'];
const welcome = require(capkpi_ui_tests_path + "/setup_wizard.js")['Welcome'];
const region = require(capkpi_ui_tests_path + "/setup_wizard.js")['Region'];
const user = require(capkpi_ui_tests_path + "/setup_wizard.js")['User'];
