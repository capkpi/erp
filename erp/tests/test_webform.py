...
class TestWebsite(unittest.TestCase):
	def test_permission_for_custom_doctype(self):
		...
		capkpi.set_user("supplier1@gmail.com")
		...
		capkpi.set_user("supplier2@gmail.com")
...
def get_data():
	webform_list_contexts = capkpi.get_hooks("webform_list_context")
	if webform_list_contexts:
		context = capkpi._dict(capkpi.get_attr(webform_list_contexts[0])("Buying") or {})
...
def create_supplier_with_contact(name, group, contact_name, contact_email):
	...
	if not capkpi.db.exists("Contact", contact_name + "-1-" + name):
