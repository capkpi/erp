...
from erp.buying.doctype.purchase_order.purchase_order import get_mapped_purchase_invoice
...
from erp.controllers.accounts_controller import get_payment_terms
...
from erp.stock.doctype.stock_entry.test_stock_entry import get_qty_after_transaction
...
class TestPurchaseInvoice(unittest.TestCase, StockTestMixin):
	...
	def test_gl_entries_with_perpetual_inventory(self):
		...
		self.assertTrue(cint(erp.is_perpetual_inventory_enabled(pi.company)), 1)
	...
	def test_subcontracting_via_purchase_invoice(self):
		from erp.buying.doctype.purchase_order.test_purchase_order import update_backflush_based_on
		from erp.stock.doctype.stock_entry.test_stock_entry import make_stock_entry
	...
	def test_debit_note(self):
		from erp.accounts.doctype.payment_entry.test_payment_entry import get_payment_entry
		from erp.accounts.doctype.sales_invoice.test_sales_invoice import get_outstanding_amount
