...
import erp
from erp.accounts.doctype.bank_account.bank_account import (
...
from erp.accounts.general_ledger import make_gl_entries, process_gl_map
from erp.accounts.party import get_party_account
from erp.accounts.utils import get_account_currency, get_balance_on, get_outstanding_invoices
...
class PaymentEntry(AccountsController):
	...
	def set_payment_req_status(self):
		from erp.accounts.doctype.payment_request.payment_request import update_payment_req_status
		...
		if self.party:
			...
			if self.party_account and self.party_type in ("Customer", "Supplier"):
				self.validate_account_type(
					self.party_account, [erp.get_party_account_type(self.party_type)]
				)
	...
	def add_party_gl_entries(self, gl_entries):
		if self.party_account:
			...
			dr_or_cr = (
				"credit" if erp.get_party_account_type(self.party_type) == "Receivable" else "debit"
			)
