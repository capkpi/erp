...
from erp.accounts.doctype.pos_closing_entry.pos_closing_entry import (
	make_closing_entry_from_opening,
)
from erp.accounts.doctype.pos_invoice.test_pos_invoice import create_pos_invoice
from erp.accounts.doctype.pos_opening_entry.test_pos_opening_entry import create_opening_entry
...
class TestPOSClosingEntry(unittest.TestCase):
	...
	def test_cancelling_of_pos_closing_entry(self):
		...
		self.assertRaises(capkpi.ValidationError, pos_inv1.cancel)

		si_doc = capkpi.get_doc("Sales Invoice", pos_inv1.consolidated_invoice)
		self.assertRaises(capkpi.ValidationError, si_doc.cancel)
