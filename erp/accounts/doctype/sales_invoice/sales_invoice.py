...
import erp
from erp.accounts.deferred_revenue import validate_service_stop_date
...
from erp.accounts.general_ledger import get_round_off_account_and_cost_center
from erp.accounts.party import get_due_date, get_party_account, get_party_details
...
from erp.controllers.accounts_controller import validate_account_head
from erp.controllers.selling_controller import SellingController
from erp.healthcare.utils import manage_invoice_submit_cancel
from erp.projects.doctype.timesheet.timesheet import get_projectwise_timesheet_data
from erp.setup.doctype.company.company import update_company_current_month_sales
from erp.stock.doctype.batch.batch import set_batch_nos
from erp.stock.doctype.delivery_note.delivery_note import update_billed_amount_based_on_so
...
class SalesInvoice(SellingController):
	...
	def set_pos_fields(self, for_validate=False):
		...
		from erp.stock.get_item_details import get_pos_profile, get_pos_profile_item_details
	...
	def make_gl_entries(self, gl_entries=None, from_repost=False):
		from erp.accounts.general_ledger import make_gl_entries, make_reverse_gl_entries
		...
		if gl_entries:
			...
			if update_outstanding == "No":
				from erp.accounts.doctype.gl_entry.gl_entry import update_outstanding_amt
	...
	def get_gl_entries(self, warehouse_account=None):
		from erp.accounts.general_ledger import merge_similar_entries
	...
	def make_item_gl_entries(self, gl_entries):
		...
		if cint(self.update_stock) and erp.is_perpetual_inventory_enabled(self.company):
	...
	def reverse_depreciation_entry_made_after_sale(self, asset):
		from erp.accounts.doctype.journal_entry.journal_entry import make_reverse_journal_entry
	...
	def apply_loyalty_points(self):
		from erp.accounts.doctype.loyalty_point_entry.loyalty_point_entry import (
