...
from erp.selling.report.sales_analytics.sales_analytics import execute


class TestAnalytics(CapKPITestCase):
	def test_sales_analytics(self):
		capkpi.db.sql("delete from `tabSales Order` where company='_Test Company 2'")
