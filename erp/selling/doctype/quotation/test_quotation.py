...
from capkpi.utils import add_days, add_months, flt, getdate, nowdate

test_dependencies = ["Product Bundle"]


class TestQuotation(CapKPITestCase):
	...
	def test_make_sales_order_terms_copied(self):
		from erp.selling.doctype.quotation.quotation import make_sales_order

		quotation = capkpi.copy_doc(test_records[0])
	...
	def test_make_sales_order(self):
		...
		self.assertRaises(capkpi.ValidationError, make_sales_order, quotation.name)
		quotation.submit()
	...
	def test_valid_till(self):
		...
		self.assertRaises(capkpi.ValidationError, quotation.validate)
	...
	def test_shopping_cart_without_website_item(self):
		if capkpi.db.exists("Website Item", {"item_code": "_Test Item Home Desktop 100"}):
			capkpi.get_last_doc("Website Item", {"item_code": "_Test Item Home Desktop 100"}).delete()
	...
	def test_quotation_expiry(self):
		from erp.selling.doctype.quotation.quotation import set_expired_status
...
test_records = capkpi.get_test_records("Quotation")
