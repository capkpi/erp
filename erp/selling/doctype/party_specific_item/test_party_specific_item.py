...
class TestPartySpecificItem(CapKPITestCase):
	def setUp(self):
		self.customer = capkpi.get_last_doc("Customer")
		self.supplier = capkpi.get_last_doc("Supplier")
		self.item = capkpi.get_last_doc("Item")
