...
class LoanWriteOff(AccountsController):
	...
	def validate_write_off_amount(self):
		...
		if self.write_off_amount > pending_principal_amount:
			capkpi.throw(_("Write off amount cannot be greater than pending principal amount"))
	...
	def update_outstanding_amount(self, cancel=0):
		written_off_amount = capkpi.db.get_value("Loan", self.loan, "written_off_amount")
		...
		capkpi.db.set_value("Loan", self.loan, "written_off_amount", written_off_amount)
