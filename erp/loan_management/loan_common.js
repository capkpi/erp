...
capkpi.ui.form.on(cur_frm.doctype, {
	refresh: function(frm) {
		if (!capkpi.boot.active_domains.includes("Non Profit")) {
	...
	applicant: function(frm) {
		...
		if (frm.doc.applicant) {
			capkpi.model.with_doc(frm.doc.applicant_type, frm.doc.applicant, function() {
				var applicant = capkpi.model.get_doc(frm.doc.applicant_type, frm.doc.applicant);
