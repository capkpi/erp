...
capkpi.ui.form.on("Rename Tool", {
	onload: function(frm) {
		return capkpi.call({
			method: "erp.utilities.doctype.rename_tool.rename_tool.get_doctypes",
			callback: function(r) {
	...
	refresh: function(frm) {
		...
		frm.page.set_primary_action(__("Rename"), function() {
			...
			capkpi.call({
				method: "erp.utilities.doctype.rename_tool.rename_tool.upload",
				args: {
