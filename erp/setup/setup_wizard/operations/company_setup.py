...
def create_email_digest():
	...
	companies = capkpi.db.sql_list("select name FROM `tabCompany`")
	for company in companies:
		if not capkpi.db.exists("Email Digest", "Default Weekly Digest - " + company):
			edigest = capkpi.get_doc(
				{
	...
	if companies:
		edigest = capkpi.new_doc("Email Digest")
		edigest.update(
			{
