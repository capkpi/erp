...
import capkpi
from capkpi.utils import add_days, add_months, flt, get_year_ending, get_year_start, getdate
...
from erp.hr.doctype.leave_application.test_leave_application import make_allocation_record
...
from erp.hr.report.employee_leave_balance.employee_leave_balance import execute
...
class TestEmployeeLeaveBalance(unittest.TestCase):
	...
	def test_employee_status_filter(self):
		...
		capkpi.db.set_value("Employee", inactive_emp, "status", "Inactive")
