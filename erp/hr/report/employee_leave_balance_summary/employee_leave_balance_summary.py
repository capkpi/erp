...
from erp.hr.report.employee_leave_balance.employee_leave_balance import (
	get_department_leave_approver_map,
)


def execute(filters=None):
	leave_types = capkpi.db.sql_list("select name from `tabLeave Type` order by name asc")
...
def get_data(filters, leave_types):
	...
	active_employees = capkpi.get_all(
		"Employee",
		filters=conditions,
