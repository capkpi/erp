...
from erp.hr.doctype.attendance.attendance import (
	get_month_map,
	get_unmarked_days,
	mark_attendance,
)
...
test_records = capkpi.get_test_records("Attendance")


class TestAttendance(CapKPITestCase):
	def setUp(self):
	...
	def test_mark_absent(self):
		...
		date = nowdate()
		capkpi.db.delete("Attendance", {"employee": employee, "attendance_date": date})
		attendance = mark_attendance(employee, date, "Absent")
		fetch_attendance = capkpi.get_value(
	...
	def test_unmarked_days(self):
		...
		capkpi.db.delete("Attendance", {"employee": employee})
		capkpi.db.set_value("Employee", employee, "holiday_list", self.holiday_list)
