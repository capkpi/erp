...
capkpi.ui.form.on('Appraisal', {
	...
	kra_template: function(frm) {
		...
		erp.utils.map_current_doc({
			method: "erp.hr.doctype.appraisal.appraisal.fetch_appraisal_template",
...
capkpi.ui.form.on('Appraisal Goal', {
	score: function(frm, cdt, cdn) {
		var d = locals[cdt][cdn];
		if (flt(d.score) > 5) {
			capkpi.msgprint(__("Score must be less than or equal to 5"));
			d.score = 0;
