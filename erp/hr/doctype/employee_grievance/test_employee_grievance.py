...
def create_employee_grievance():
	...
	grievance = capkpi.new_doc("Employee Grievance")
...
def create_grievance_type():
	if capkpi.db.exists("Grievance Type", "Employee Abuse"):
		return capkpi.get_doc("Grievance Type", "Employee Abuse")
	grievance_type = capkpi.new_doc("Grievance Type")
