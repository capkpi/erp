...
capkpi.ui.form.on('Job Opening', {
	...
	designation: function(frm) {
		if(frm.doc.designation && frm.doc.company){
			capkpi.call({
				"method": "erp.hr.doctype.staffing_plan.staffing_plan.get_active_staffing_plan_details",
				args: {
					company: frm.doc.company,
					designation: frm.doc.designation,
					date: capkpi.datetime.now_date() // ToDo - Date in Job Opening?
				},
