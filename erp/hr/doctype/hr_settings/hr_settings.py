...
class HRSettings(Document):
	...
	def show_freq_change_warning(self, from_date, to_date):
		from_date = capkpi.bold(format_date(from_date))
		to_date = capkpi.bold(format_date(to_date))
		capkpi.msgprint(
			msg=capkpi._(
			...
			primary_action={
				"label": capkpi._("Yes, Proceed"),
				"client_action": "erp.proceed_save_with_reminders_frequency_change",
			},
			raise_exception=capkpi.ValidationError,
		)
